...
#***********************************************INTRO**********************************************************************
#Spiel Hangman
#Stefanie Jux (20109009) - Data Science SS2018

#Vorüberlegungen und Ausbaustufe:
#Spielregeln
#Zufallswort
#Benutzereingabe entgegennehmen
#Welche Buchstaben wurden schon eingegeben
#Versuchszaehler hoch zaehlen
#Benutzerverwaltung: Neustart nur die noch nicht gelösten Wörter
#Fehlerbehandlung vervollständigen
"""Wörterbuch - Zuordnung, z.B. Berlin - Weltzeituhr, Alexanderplatz, Olympia Stadion => 
3 Schwierigkeitsstufen (Leicht - pro Wort 15 Versuche, 
                        Mittel - für die ersten zwei Wörter 15 Versuche und nochmal 15 Versuche für das dritte Wort, 
                        Schwierig - alle 3 Wörter in 15 Versuchen)"""
#Alternative - Kategorien: Länder, Städte, Tiere...
